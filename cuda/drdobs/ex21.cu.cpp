# 1 "/tmp/tmpxft_00000a11_00000000-1_ex21.cudafe1.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/tmp/tmpxft_00000a11_00000000-1_ex21.cudafe1.cpp"
# 1 "ex21.cu"
...
# 37 "ex21.cu"
cudaConfigureCall(nBlocks, blockSize) ? ((void)0) : incrementArrayOnDevice(a_d, N);
# 39 "ex21.cu"
cudaMemcpy(b_h, a_d, sizeof(float) * N, cudaMemcpyDeviceToHost);
# 41 "ex21.cu"
for (i = 0; i < N; i++) { ((a_h[i]) == (b_h[i])) ? (static_cast< void>(0)) : __assert_fail("a_h[i] == b_h[i]", "ex21.cu", 41, __PRETTY_FUNCTION__); }
# 43 "ex21.cu"
...
# 1 "/tmp/tmpxft_00000a11_00000000-1_ex21.cudafe1.stub.c"
# 1 "/tmp/tmpxft_00000a11_00000000-1_ex21.cudafe1.stub.c" 1
# 1 "/tmp/tmpxft_00000a11_00000000-3_ex21.fatbin.c" 1
...
# 2 "/tmp/tmpxft_00000a11_00000000-3_ex21.fatbin.c" 2
...
0x30305f3131613030ull,0x372d303030303030ull,0x70632e313278655full,0x742f2820692e3370ull,
0x23494263632f706dull,0x295876705545692eull,0x2d2d2d2d2f2f090aull,0x2d2d2d2d2d2d2d2dull,
0x2d2d2d2d2d2d2d2dull,0x2d2d2d2d2d2d2d2dull,0x2d2d2d2d2d2d2d2dull,0x2d2d2d2d2d2d2d2dull,
...
0x6c69662e090a223eull,0x6d742f2209320965ull,0x746678706d742f70ull,0x316130303030305full,
0x3030303030305f31ull,0x3278655f362d3030ull,0x6566616475632e31ull,0x090a227570672e32ull,
0x093309656c69662eull,0x696c2f7273752f22ull,0x34692f6363672f62ull,0x78756e696c2d3638ull,
0x332e342f756e672dull,0x756c636e692f342eull,0x65646474732f6564ull,0x662e090a22682e66ull,
...
0x662e090a22682e73ull,0x2209363109656c69ull,0x636f6c2f7273752full,0x2f616475632f6c61ull,
...
0x5f6d732f6564756cull,0x696d6f74615f3032ull,0x6974636e75665f63ull,0x090a22682e736e6full,
0x363209656c69662eull,0x6c2f7273752f2209ull,0x6475632f6c61636full,0x2e2e2f6e69622f61ull,
0x6564756c636e692full,0x695f30325f6d732full,0x6369736e6972746eull,0x662e090a22682e73ull,
0x2209373209656c69ull,0x636f6c2f7273752full,0x2f616475632f6c61ull,0x692f2e2e2f6e6962ull,
0x6d2f6564756c636eull,0x636e75665f687461ull,0x62645f736e6f6974ull,0x682e317874705f6cull,
0x656c69662e090a22ull,0x3278652209383209ull,0x0a0a0a2275632e31ull,0x207972746e652e09ull,
0x72636e6932325a5full,0x727241746e656d65ull,0x697665446e4f7961ull,0x0a28206966506563ull,
0x6d617261702e0909ull,0x5f5f203233752e20ull,0x6d72617061647563ull,0x636e6932325a5f5full,
0x7241746e656d6572ull,0x7665446e4f796172ull,0x615f696650656369ull,0x7261702e09090a2cull,
0x203233732e206d61ull,0x6170616475635f5full,0x6932325a5f5f6d72ull,0x746e656d6572636eull,
0x446e4f7961727241ull,0x6966506563697665ull,0x090a7b090a294e5full,0x31752e206765722eull,
...
0x2e747865742e006cull,0x72636e6932325a5full,0x727241746e656d65ull,0x697665446e4f7961ull,
0x6e2e006966506563ull,0x5f2e6f666e692e76ull,0x6572636e6932325aull,0x61727241746e656dull,
0x63697665446e4f79ull,0x766e2e0069665065ull,0x2e6465726168732eull,0x72636e6932325a5full,
0x727241746e656d65ull,0x697665446e4f7961ull,0x5f00006966506563ull,0x6572636e6932325aull,
0x61727241746e656dull,0x63697665446e4f79ull,0x0000000069665065ull,0x0000000000000000ull,
0x0000000000000000ull,0x0000000000000000ull,0x0000000001000300ull,0x0000000000000000ull,
0x0000000002000300ull,0x0000000000000000ull,0x0000000003000300ull,0x0000000000000000ull,
0x0000000000000300ull,0x0000000000000000ull,0x0000000000000300ull,0x0000500000000000ull,
0x0000000004000300ull,0x0000000000000000ull,0x0000000005000300ull,0x0000000000000000ull,
0x0000010006000300ull,0x0000000000000000ull,0x0042050004101200ull,0x0000050023c78010ull,
0x014c0104000780a0ull,0x00cbfd0020478060ull,0x0000036c20c7c830ull,0x0200010000028030ull,
0x00c805c410078030ull,0x0e02010420078020ull,0x00000180c00780d0ull,0x0e020103f80003b0ull,
0x080b04a0c00781d0ull,0x0000040000000000ull,0x01000800080d0400ull,0x0000000000000100ull,
0x0000032000000006ull,0x0000000000000000ull,0x0000006000000060ull,0x0000000400000005ull,
0x000002b560000000ull,0x0000000000000000ull,0x0000006800000068ull,0x0000000400000905ull,
0x0000031d60000000ull,0x0000000000000000ull,0x0000001800000000ull,0x0000000400000906ull,
...
static __cudaFatCudaBinary __fatDeviceText __attribute__ ((section (".nvFatBinSegment")))= {0x1ee55a01,0x00000004,0x2e00b786,(char*)"dd120ace6f427187",(char*)"ex21.cu",(char*)" ",__ptxEntries,__cubinEntries,&__debugEntries0,0,0,0,0,0,0x31b79e74,&__elfEntries1};
# 2 "/tmp/tmpxft_00000a11_00000000-1_ex21.cudafe1.stub.c" 2
...
# 3 "/tmp/tmpxft_00000a11_00000000-1_ex21.cudafe1.stub.c" 2




struct __T20 {float *__par0;int __par1;int __dummy_field;};
static void __sti____cudaRegisterAll_39_tmpxft_00000a11_00000000_4_ex21_cpp1_ii_54bfc6dd(void) __attribute__((__constructor__));
void __device_stub__Z22incrementArrayOnDevicePfi(float *__par0, int __par1){auto struct __T20 *__T21;
*(void**)(void*)&__T21 = (void*)0;if (cudaSetupArgument((void*)(char*)&__par0, sizeof(__par0), (size_t)&__T21->__par0) != cudaSuccess) return;if (cudaSetupArgument((void*)(char*)&__par1, sizeof(__par1), (size_t)&__T21->__par1) != cudaSuccess) return;{ volatile static char *__f; __f = ((char *)((void ( *)(float *, int))incrementArrayOnDevice)); (void)cudaLaunch(((char *)((void ( *)(float *, int))incrementArrayOnDevice))); };}
void incrementArrayOnDevice( float *__cuda_0,int __cuda_1)
# 11 "ex21.cu"
{__device_stub__Z22incrementArrayOnDevicePfi( __cuda_0,__cuda_1);
...
static void __sti____cudaRegisterAll_39_tmpxft_00000a11_00000000_4_ex21_cpp1_ii_54bfc6dd(void) { __cudaFatCubinHandle = __cudaRegisterFatBinary((void*)&__fatDeviceText); atexit(__cudaUnregisterBinaryUtil); __cudaRegisterFunction(__cudaFatCubinHandle, (const char*)((void ( *)(float *, int))incrementArrayOnDevice), (char*)"_Z22incrementArrayOnDevicePfi", "_Z22incrementArrayOnDevicePfi", -1, (uint3*)0, (uint3*)0, (dim3*)0, (dim3*)0, (int*)0); }
# 1 "/tmp/tmpxft_00000a11_00000000-1_ex21.cudafe1.stub.c" 2
