# 1 "/tmp/tmpxft_000007e8_00000000-1_first_sample_2d.cudafe1.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/tmp/tmpxft_000007e8_00000000-1_first_sample_2d.cudafe1.cpp"
# 1 "first_sample_2d.cu"
...
# 11 "first_sample_2d.cu"
typedef cudaDeviceProp cudaDevProp_t;
# 16 "first_sample_2d.cu"
void foo(float *A, int N, int M);
# 30 "first_sample_2d.cu"
int main()
# 31 "first_sample_2d.cu"
{
# 32 "first_sample_2d.cu"
float *a_h, *a_d;
# 33 "first_sample_2d.cu"
const int N = 1000;
# 34 "first_sample_2d.cu"
const int M = 10000;
# 35 "first_sample_2d.cu"
int ct, dev;
# 36 "first_sample_2d.cu"
cudaDevProp_t prop;
# 38 "first_sample_2d.cu"
cudaGetDeviceCount(&ct);
# 40 "first_sample_2d.cu"
if (ct == 0) {
# 41 "first_sample_2d.cu"
printf("\nNo CUDA device found.\n");
# 42 "first_sample_2d.cu"
exit(0);
# 43 "first_sample_2d.cu"
}
# 45 "first_sample_2d.cu"
cudaGetDevice(&dev);
# 46 "first_sample_2d.cu"
cudaGetDeviceProperties(&prop, dev);
# 48 "first_sample_2d.cu"
int block_size = (prop.maxThreadsPerBlock);
# 49 "first_sample_2d.cu"
int n_blocks = (((N * M) / block_size) + (((N % block_size) == 0) ? 0 : 1));
# 51 "first_sample_2d.cu"
size_t size = ((N * M) * sizeof(float));
# 53 "first_sample_2d.cu"
a_h = ((float *)malloc(size));
# 54 "first_sample_2d.cu"
cudaMalloc((void **)(&a_d), size);
# 55 "first_sample_2d.cu"
cudaMemcpy(a_d, a_h, size, cudaMemcpyHostToDevice);
# 59 "first_sample_2d.cu"
cudaConfigureCall(n_blocks, block_size) ? ((void)0) : foo(a_d, N, M);
# 62 "first_sample_2d.cu"
cudaMemcpy(a_h, a_d, (sizeof(float) * (N)) * (M), cudaMemcpyDeviceToHost);
# 72 "first_sample_2d.cu"
printf("\n\n%d\n\n", (int)(a_h[(M * (N - 1)) + (M - 1)]));
# 74 "first_sample_2d.cu"
free(a_h);
# 75 "first_sample_2d.cu"
cudaFree(a_d);
# 76 "first_sample_2d.cu"
return 0;
# 77 "first_sample_2d.cu"
}
# 1 "/tmp/tmpxft_000007e8_00000000-1_first_sample_2d.cudafe1.stub.c"
# 1 "/tmp/tmpxft_000007e8_00000000-1_first_sample_2d.cudafe1.stub.c" 1
# 1 "/tmp/tmpxft_000007e8_00000000-3_first_sample_2d.fatbin.c" 1
...
# 2 "/tmp/tmpxft_000007e8_00000000-3_first_sample_2d.fatbin.c" 2
...
0x30305f3865373030ull,0x372d303030303030ull,0x735f74737269665full,0x64325f656c706d61ull,
0x20692e337070632eull,0x63632f706d742f28ull,0x7138644b2e234942ull,0x2d2f2f090a29586full,
0x2d2d2d2d2d2d2d2dull,0x2d2d2d2d2d2d2d2dull,0x2d2d2d2d2d2d2d2dull,0x2d2d2d2d2d2d2d2dull,
...
0x6169646e45202c30ull,0x656c7474696c3a6eull,0x65746e696f50202cull,0x333a657a69532072ull,
0x2d20202f2f090a32ull,0x6974704f2809334full,0x6e6f6974617a696dull,0x0a296c6576656c20ull,
...
0x303030305f746678ull,0x3030305f38653730ull,0x5f362d3030303030ull,0x61735f7473726966ull,
0x2e64325f656c706dull,0x2e32656661647563ull,0x662e090a22757067ull,0x2f22093309656c69ull,
0x2f62696c2f727375ull,0x363834692f636367ull,0x672d78756e696c2dull,0x342e332e342f756eull,
0x6564756c636e692full,0x2e6665646474732full,0x6c69662e090a2268ull,0x73752f2209340965ull,
...
ull,0x0000000000000000ull,
0x0000000000000000ull,0x0000000000000000ull,0x0000000000000000ull,0x0000000100000000ull,
0x0000000000000003ull,0x0000014c00000000ull,0x0000000000000071ull,0x0000000400000000ull,
0x0000000b00000000ull,0x0000000000000003ull,0x000001bd00000000ull,0x000000000000000cull,
0x0000000100000000ull,0x0000001300000000ull,0x0000000000000002ull,0x000001c900000000ull,
0x00000002000000a0ull,0x0000000100000009ull,0x0000003600000010ull,0x0000000600000001ull,
0x0000026900000000ull,0x00000003000000b8ull,0x0000000404000006ull,0x0000004700000000ull,
0x0000000200000001ull,0x0000032100000000ull,0x000000000000001cull,0x0000000100000004ull,
0x0000005b00000000ull,0x0000000300000008ull,0x0000033d00000000ull,0x000000000000001cull,
0x0000000400000004ull,0x68732e0000000000ull,0x2e00626174727473ull,0x2e00626174727473ull,
0x2e006261746d7973ull,0x61626f6c672e766eull,0x2e0074696e692e6cull,0x61626f6c672e766eull,
0x2e747865742e006cull,0x66506f6f66335a5full,0x692e766e2e006969ull,0x66335a5f2e6f666eull,
0x2e00696966506f6full,0x65726168732e766eull,0x6f6f66335a5f2e64ull,0x5a5f000069696650ull,
0x696966506f6f6633ull,0x0000000000000000ull,0x0000000000000000ull,0x0000000000000000ull,
...
0x0000030000000000ull,0x0000000000000000ull,0x040003000000b800ull,0x0000000000000000ull,
0x0500030000000000ull,0x0000000000000000ull,0x0600030000000000ull,0x0000000000000100ull,
0x0410120000000000ull,0x23c7801000420500ull,0x000780a000000500ull,0x20478060014c0504ull,
0x20c7c83001cbfd00ull,0x000280300000036cull,0x20c7c8307ccdfd00ull,0x000280300000036cull,
0x23c7801000cc0100ull,0x0007804003000904ull,0x0087806002020900ull,0x1007803010040900ull,
0x00878060020001c4ull,0x2007802000cc0900ull,0x1007803002000504ull,0x10078030020409c4ull,
0x02e8082101e804c4ull,0x014780a000000d21ull,0xc00780d00e020d44ull,0x00000320048205a0ull,
0x0147c8300203fd00ull,0x0000032001800164ull,0x0002801001000300ull,0x000001f000000100ull,
0x000000000c0b04e0ull,0x0000080000000400ull,0x20010000080d0400ull,0x0000000000002000ull,
0x0000034000000006ull,0x0000000000000000ull,0x0000006000000060ull,0x0000000400000005ull,
0x0000026960000000ull,0x0000000000000000ull,0x000000d4000000d4ull,0x0000000400000905ull,
0x0000033d60000000ull,0x0000000000000000ull,0x0000001c00000000ull,0x0000000400000906ull,
...
static __cudaFatCudaBinary __fatDeviceText __attribute__ ((section (".nvFatBinSegment")))= {0x1ee55a01,0x00000004,0x2e00b786,(char*)"9bf942bee5307330",(char*)"first_sample_2d.cu",(char*)" ",__ptxEntries,__cubinEntries,&__debugEntries0,0,0,0,0,0,0x5103e230,&__elfEntries1};
# 2 "/tmp/tmpxft_000007e8_00000000-1_first_sample_2d.cudafe1.stub.c" 2
...
# 3 "/tmp/tmpxft_000007e8_00000000-1_first_sample_2d.cudafe1.stub.c" 2




struct __T20 {float *__par0;int __par1;int __par2;int __dummy_field;};
static void __sti____cudaRegisterAll_50_tmpxft_000007e8_00000000_4_first_sample_2d_cpp1_ii_4a0bbf2b(void) __attribute__((__constructor__));
void __device_stub__Z3fooPfii(float *__par0, int __par1, int __par2){auto struct __T20 *__T21;
*(void**)(void*)&__T21 = (void*)0;if (cudaSetupArgument((void*)(char*)&__par0, sizeof(__par0), (size_t)&__T21->__par0) != cudaSuccess) return;if (cudaSetupArgument((void*)(char*)&__par1, sizeof(__par1), (size_t)&__T21->__par1) != cudaSuccess) return;if (cudaSetupArgument((void*)(char*)&__par2, sizeof(__par2), (size_t)&__T21->__par2) != cudaSuccess) return;{ volatile static char *__f; __f = ((char *)((void ( *)(float *, int, int))foo)); (void)cudaLaunch(((char *)((void ( *)(float *, int, int))foo))); };}
void foo( float *__cuda_0,int __cuda_1,int __cuda_2)
# 17 "first_sample_2d.cu"
{__device_stub__Z3fooPfii( __cuda_0,__cuda_1,__cuda_2);
# 25 "first_sample_2d.cu"
}
# 1 "/tmp/tmpxft_000007e8_00000000-1_first_sample_2d.cudafe1.stub.c"



static void __sti____cudaRegisterAll_50_tmpxft_000007e8_00000000_4_first_sample_2d_cpp1_ii_4a0bbf2b(void) { __cudaFatCubinHandle = __cudaRegisterFatBinary((void*)&__fatDeviceText); atexit(__cudaUnregisterBinaryUtil); __cudaRegisterFunction(__cudaFatCubinHandle, (const char*)((void ( *)(float *, int, int))foo), (char*)"_Z3fooPfii", "_Z3fooPfii", -1, (uint3*)0, (uint3*)0, (dim3*)0, (dim3*)0, (int*)0); }
# 1 "/tmp/tmpxft_000007e8_00000000-1_first_sample_2d.cudafe1.stub.c" 2
