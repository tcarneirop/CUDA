# 1 "/tmp/tmpxft_00000a41_00000000-1_second_sample_2d.cudafe1.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/tmp/tmpxft_00000a41_00000000-1_second_sample_2d.cudafe1.cpp"
# 1 "second_sample_2d.cu"
...
# 12 "second_sample_2d.cu"
typedef cudaDeviceProp cudaDevProp_t;
# 17 "second_sample_2d.cu"
void bar(float *A, int N, int M);
# 25 "second_sample_2d.cu"
void checkCUDAError(const char *msg)
# 26 "second_sample_2d.cu"
{
# 27 "second_sample_2d.cu"
cudaError_t err = cudaGetLastError();
# 28 "second_sample_2d.cu"
if ((cudaSuccess) != err)
# 29 "second_sample_2d.cu"
{
# 30 "second_sample_2d.cu"
fprintf(stderr, "Cuda error: %s: %s.\n", msg, cudaGetErrorString(err));
# 32 "second_sample_2d.cu"
exit(1);
# 33 "second_sample_2d.cu"
}
# 34 "second_sample_2d.cu"
}
# 37 "second_sample_2d.cu"
int main()
# 38 "second_sample_2d.cu"
{
# 39 "second_sample_2d.cu"
float *a_h, *a_d;
# 40 "second_sample_2d.cu"
const int N = 1000;
# 41 "second_sample_2d.cu"
const int M = 10000;
# 43 "second_sample_2d.cu"
int ct, dev;
# 44 "second_sample_2d.cu"
cudaDevProp_t prop;
# 47 "second_sample_2d.cu"
cudaGetDeviceCount(&ct);
# 48 "second_sample_2d.cu"
if (ct == 0) {
# 49 "second_sample_2d.cu"
printf("\nNo CUDA device found.\n");
# 50 "second_sample_2d.cu"
exit(0);
# 51 "second_sample_2d.cu"
}
# 52 "second_sample_2d.cu"
cudaGetDevice(&dev);
# 53 "second_sample_2d.cu"
cudaGetDeviceProperties(&prop, dev);
# 55 "second_sample_2d.cu"
dim3 bDim(16, 16);
# 58 "second_sample_2d.cu"
dim3 gDim(((N) / (bDim.x)) + ((((N) % (bDim.x)) == (0)) ? 0 : 1), ((M) / (bDim.y)) + ((((M) % (bDim.y)) == (0)) ? 0 : 1));
# 60 "second_sample_2d.cu"
size_t size = ((N * M) * sizeof(float));
# 62 "second_sample_2d.cu"
a_h = ((float *)malloc(size));
# 64 "second_sample_2d.cu"
cudaMalloc((void **)(&a_d), size);
# 65 "second_sample_2d.cu"
cudaMemcpy(a_d, a_h, size, cudaMemcpyHostToDevice);
# 69 "second_sample_2d.cu"
cudaConfigureCall(gDim, bDim) ? ((void)0) : bar(a_d, N, M);
# 75 "second_sample_2d.cu"
cudaMemcpy(a_h, a_d, (sizeof(float) * (N)) * (M), cudaMemcpyDeviceToHost);
# 88 "second_sample_2d.cu"
printf("\n\n%d\n\n", (int)(a_h[(M * (N - 1)) + (M - 1)]));
# 93 "second_sample_2d.cu"
free(a_h);
# 94 "second_sample_2d.cu"
cudaFree(a_d);
# 97 "second_sample_2d.cu"
return 0;
# 98 "second_sample_2d.cu"
}
# 1 "/tmp/tmpxft_00000a41_00000000-1_second_sample_2d.cudafe1.stub.c"
# 1 "/tmp/tmpxft_00000a41_00000000-1_second_sample_2d.cudafe1.stub.c" 1
# 1 "/tmp/tmpxft_00000a41_00000000-3_second_sample_2d.fatbin.c" 1
...
# 2 "/tmp/tmpxft_00
0x62335a5f2e6f666eull,0x2e00696966507261ull,0x65726168732e766eull,0x726162335a5f2e64ull,
0x766e2e0069696650ull,0x6e6174736e6f632eull,0x6162335a5f2e3174ull,0x5f00006969665072ull,
0x696650726162335aull,0x0000000000000069ull,0x0000000000000000ull,0x0000000000000000ull,
0x0003000000000000ull,0x0000000000000001ull,0x0003000000000000ull,0x0000000000000002ull,
0x0003000000000000ull,0x0000000000000003ull,0x0003000000000000ull,0x0000000000000000ull,
0x0003000000000000ull,0x0000000000000000ull,0x0003000000a00000ull,0x0000000000000004ull,
0x0003000000000000ull,0x0000000000000006ull,0x0003000000000000ull,0x0000000000000007ull,
0x0003000000000000ull,0x0000000000010005ull,0x1012000000000000ull,0xc780100042090004ull,
0x0780d08002050023ull,0x0780a00000090040ull,0xc780100044010400ull,0x0780a000020d0023ull,
0x878060024c050400ull,0xc78060004e090020ull,0x07c83001cbfd0020ull,0x02c83002cdfd6c21ull,
0x0100300000036c21ull,0xc7801000cc010000ull,0x07804003000d0423ull,0xc7806002020d0000ull,
0x07803010060d0000ull,0xc78060020001c410ull,0x8780200000010000ull,0x0780300200050400ull,
0x4780a0000009c410ull,0x47802000c8014401ull,0x0781d00e00090420ull,0x0b04000003ffa0c0ull,
0x000400000000000cull,0x0d04000000080000ull,0x0001000100080008ull,0x0000000600000000ull,
0x000000000000037cull,0x0000006000000000ull,0x0000000500000060ull,0x6000000000000004ull,
0x00000000000002baull,0x000000c000000000ull,0x00000a05000000c0ull,0x6000000000000004ull,
0x000000000000037aull,0x0000000000000000ull,0x00000a060000001cull,0x0000000000000004ull
};
...
static __cudaFatCudaBinary __fatDeviceText __attribute__ ((section (".nvFatBinSegment")))= {0x1ee55a01,0x00000004,0x2e00b786,(char*)"6666c115809e6ac6",(char*)"second_sample_2d.cu",(char*)" ",__ptxEntries,__cubinEntries,&__debugEntries0,0,0,0,0,0,0x5696ee98,&__elfEntries1};
# 2 "/tmp/tmpxft_00000a41_00000000-1_second_sample_2d.cudafe1.stub.c" 2
...
# 3 "/tmp/tmpxft_00000a41_00000000-1_second_sample_2d.cudafe1.stub.c" 2




struct __T20 {float *__par0;int __par1;int __par2;int __dummy_field;};
static void __sti____cudaRegisterAll_51_tmpxft_00000a41_00000000_4_second_sample_2d_cpp1_ii_1c3ea97b(void) __attribute__((__constructor__));
void __device_stub__Z3barPfii(float *__par0, int __par1, int __par2){auto struct __T20 *__T21;
*(void**)(void*)&__T21 = (void*)0;if (cudaSetupArgument((void*)(char*)&__par0, sizeof(__par0), (size_t)&__T21->__par0) != cudaSuccess) return;if (cudaSetupArgument((void*)(char*)&__par1, sizeof(__par1), (size_t)&__T21->__par1) != cudaSuccess) return;if (cudaSetupArgument((void*)(char*)&__par2, sizeof(__par2), (size_t)&__T21->__par2) != cudaSuccess) return;{ volatile static char *__f; __f = ((char *)((void ( *)(float *, int, int))bar)); (void)cudaLaunch(((char *)((void ( *)(float *, int, int))bar))); };}
void bar( float *__cuda_0,int __cuda_1,int __cuda_2)
# 17 "second_sample_2d.cu"
{__device_stub__Z3barPfii( __cuda_0,__cuda_1,__cuda_2);
# 23 "second_sample_2d.cu"
}
# 1 "/tmp/tmpxft_00000a41_00000000-1_second_sample_2d.cudafe1.stub.c"



static void __sti____cudaRegisterAll_51_tmpxft_00000a41_00000000_4_second_sample_2d_cpp1_ii_1c3ea97b(void) { __cudaFatCubinHandle = __cudaRegisterFatBinary((void*)&__fatDeviceText); atexit(__cudaUnregisterBinaryUtil); __cudaRegisterFunction(__cudaFatCubinHandle, (const char*)((void ( *)(float *, int, int))bar), (char*)"_Z3barPfii", "_Z3barPfii", -1, (uint3*)0, (uint3*)0, (dim3*)0, (dim3*)0, (int*)0); }
# 1 "/tmp/tmpxft_00000a41_00000000-1_second_sample_2d.cudafe1.stub.c" 2
